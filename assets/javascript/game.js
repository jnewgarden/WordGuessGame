...
var doubleWord = ['a', 'b', 'c',
    ...
    'v', 'w', 'x',
    'y', 'z'];
//Holds the all the characters
var wordBank = ['varian', 'sylvanas', 'sora', 'dukenukem', 'mario', 'sonic', 'link', 'cloud', 'scorpion','donkeykong','kratos','broxxigar'];
//Holds choosenWord
var choosenWord = "";
...
function winLose() {
    // When number blanks is filled with right words you win
    if (rightGuessCounter === numBlanks) {
        //Counts Wins 
        winCount++;
        //add wins and put in the wins box
        document.getElementById('winCounter').innerHTML = winCount;
